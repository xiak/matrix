...
func loadInstallationOpenAPI(t *testing.T) map[string]any {
	t.Helper()
...
func installationOpenAPISchemas(t *testing.T, document map[string]any) map[string]any {
	t.Helper()
...
func compileInstallationOpenAPISchema(
	t *testing.T,
	...
	resource := "https://installation.matrix.xiak.com/contracts/" + name + ".json"
...
func decodeInstallationExample[T any](t *testing.T, path string) T {
	t.Helper()
...
func loadInstallationSchemaExample(t *testing.T, path string) map[string]any {
	t.Helper()
