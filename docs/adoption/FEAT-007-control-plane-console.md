...
| IAM account-access capability contract | `4201989773b6ca24829506b7e60dc3f9c4f20446` | Same repository, fixed after verification run `34605172417`. Selectively adapt its public IAM wire/domain semantics and boundary tests into the existing console; do not cherry-pick its generated UI, styles or backend runtime. |
