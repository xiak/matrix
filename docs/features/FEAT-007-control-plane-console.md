...
| Gate | Evidence |
| --- | --- |
| Supported frontend runtime | Node 23.11.1; complete `build:embedded` plus type, lint, architecture and style gates passed. All 600 Vitest cases across 40 files and three static-normalization cases passed with the existing five-second per-test timeout unchanged. |
