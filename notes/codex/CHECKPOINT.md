...
- Pushed design milestone: `fbdb250`
...
2. [FEAT-008 adoption](../../docs/adoption/FEAT-008-linux-host-management.md)
   owns fixed-source decisions; review is not yet complete.
...
The pushed milestone contains design only, not an accepted implementation.
Continue the first unfinished iteration in the FEAT, one usable slice at a
time. Keep Phase 2 isolated and preserve its branch/worktree/runtime. Follow
AGENTS.md's single-owner documentation and behavior-based testing rules.
