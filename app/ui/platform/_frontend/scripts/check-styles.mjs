...
process.stdout.write(`platform UI style check passed (${contrastPairs.length * Object.keys(themes).length} contrast pairs across light/mixed/dark workspace and shell surfaces)\n`);
