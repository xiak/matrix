...
func (service *Dispatcher) DispatchOnce(ctx context.Context) (Result, error) {
	...
	case authority.MailContactVerified, authority.MailAuthenticatorBound, authority.MailAuthenticatorReplaced, authority.MailRecoveryStarted, authority.MailAuthenticatorRecovered,
