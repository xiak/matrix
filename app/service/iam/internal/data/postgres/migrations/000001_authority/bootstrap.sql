...
BEGIN
    ...
    LOOP
        FOREACH member_name IN ARRAY ARRAY['matrix_iam_api', 'matrix_iam_worker', 'matrix_iam_credential_recovery', 'matrix_iam_backup_custody', 'matrix_iam_notification_worker']
        LOOP
            IF EXISTS (
                SELECT 1
...
BEGIN
    FOREACH other_role IN ARRAY ARRAY['matrix_iam_api','matrix_iam_worker'] LOOP
