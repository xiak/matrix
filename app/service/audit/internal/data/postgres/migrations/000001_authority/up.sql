...
BEGIN
    ...
    SELECT contract.source, contract.target_kind, contract.result,
      ...
      FROM (VALUES
		...
		('devops.source-connection.recheck-scheduled', 'DEVOPS', 'SOURCE_CONNECTION', 'SUCCEEDED', true, true, true),
		...
		('devops.repository-binding.recheck-scheduled', 'DEVOPS', 'REPOSITORY_BINDING', 'SUCCEEDED', true, true, true),
