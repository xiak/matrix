...
// SupportedDatabaseUpgradePredecessorProfile is the one authenticated
// installed profile that this source can upgrade in place. It is an exact
// release contract, not a numeric N-1 rule.
