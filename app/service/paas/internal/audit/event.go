...
const (
	...
	ExecutionTargetDrained       = "paas.execution-target.drained"
	ExecutionTargetActivated     = "paas.execution-target.activated"
	ExecutionTargetRemoved       = "paas.execution-target.removed"
