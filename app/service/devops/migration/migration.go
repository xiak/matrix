...
func Apply(ctx context.Context, adminDSN, apiDSN, workerDSN, sourceObserverDSN string) error {
...
func VerifyInstalled(ctx context.Context, adminDSN, apiDSN, workerDSN, sourceObserverDSN string) error {
